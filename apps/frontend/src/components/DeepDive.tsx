...
function StatCard({
    ...
    return (
        <div className="border-2 border-black p-3 sm:p-5 text-center hover:bg-gray-50 transition-colors">
            ...
            <p className="text-xs text-gray-600 leading-snug hidden sm:block">{description}</p>
        </div>
    );
}
...
function ExpandableSection({
    ...
    return (
        <div className="border-2 border-black overflow-hidden">
            ...
            {open && (
                <div className="border-t-2 border-black p-3 sm:p-5 space-y-4">{children}</div>
            )}
        </div>
    );
}
            ...
            <div className="space-y-4 mb-10">
                ...
                >
                    <p className="text-sm text-gray-700 leading-relaxed">
                        The retrieval system combines two complementary search strategies and
                        fuses their results for optimal relevance.
                    </p>
                        ...
                        <div className="border border-black p-4">
                            ...
                            <div className="space-y-2 text-xs text-gray-600">
                                ...
                                <div className="flex items-center gap-2">
                                    <span className="w-2 h-2 bg-gray-300 rounded-full flex-shrink-0" />
                                    <span>
                                        <strong>Too much context</strong> — attention dilutes, output
                                        degrades
                                    </span>
                                </div>
                                <div className="flex items-center gap-2">
                ...
                >
                    <p className="text-sm text-gray-700 leading-relaxed">
                        The generation pipeline uses LangGraph to orchestrate multi-step code
                        generation with automated validation and retry logic.
                    </p>
                ...
                >
                    ...
                    <div className="border border-black p-4 bg-gray-50 mt-4">
                        ...
                        <p className="text-xs text-gray-600 leading-relaxed">
                            BullMQ manages concurrent request processing with ordered
                            queuing, automatic retry on failure, and backpressure handling.
                            No single slow job blocks the pipeline.
                        </p>
                    </div>
                </ExpandableSection>
            </div>
